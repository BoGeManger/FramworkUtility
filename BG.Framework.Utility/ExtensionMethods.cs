...
namespace BG.Framework.Utility
{
    public static class ExtensionMethods
    {
        ...
        public static string ToJsonString(this DataTable source)
        {
            ...
            bool flag = !dataTable.Columns.Contains("DataRowState");
            if (flag)
            {
                dataTable.Columns.Add("DataRowState", typeof(string));
            }
            foreach (DataRow dataRow in dataTable.Rows)
            {
                ...
                if (flag2)
                {
                    ...
                    dataRow["DataRowState"] = DataRowState.Deleted.ToString();
                }
                else
                {
                    dataRow["DataRowState"] = dataRow.RowState.ToString();
                }
            }
